...
export default function FollowersPage() {
  ...
  const fetchFollowers = async () => {
    ...
    try {
      ...
      if (res.ok) {
        const data: FollowersData = await res.json();
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            {total} {total === 1 ? 'person' : 'people'} following @{username}
          </p>
        </div>
        ...
        {loading && page === 1 ? (
          ...
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
            ...
            <p className="mt-2 text-gray-600">When people follow this user, they'll show up here</p>
          </div>
        ) : (
          <>
